...
public class Practical_5
{
    public static void main(String[] args) {
        ...
        AIDS aids = new AIDS("Ishant Morghade", "Vedant Shende", "Peeyush Kaware", "Bhavesh More", "Samarth Sharma");
        CSE cse = new CSE("Ishant Morghade", "Vedant Shende", "Peeyush Kaware", "Bhavesh More", "Samarth Sharma");
